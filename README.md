...
本仓库的 Skills 不仅限于 WorkBuddy，也可以适配到 **Cursor、VS Code+Continue、Claude Desktop、Cherry Studio、Open WebUI** 等主流 AI 工具。
...
| 工具 | 配置方式 | 触发方法 |
|---|---|---|
| WorkBuddy |  目录 | 自然语言自动触发 |
| Cursor |  |  引用或  |
| VS Code + Continue |  Slash Commands |  触发 |
| Claude Desktop | Settings → Custom Instructions | 对话中自然触发 |
| Cherry Studio | 助手 → System Prompt | 选择对应助手 |
| Open WebUI | 模型 → System Prompt | 选择对应模型 |
